...
We have a variable, _*"pdays"*_ indicating the # days after an individual was last contacted by a previous subsidy program. Using the **"tally"** function, we can see that the majority of individuals in our dataset have a pdays value of '999,' meaning they were not previously contacted. Because this 999 value is overhwelmingly present in our data, in may skew our results and compromise the efficacy of the variable. **To remedy this, we will create a new pdays column ("days") that omits 999 values.** 
