...
We have a variable, _*"pdays"*_ indicating the # days after an individual was last contacted by a previous subsidy program. Using the **"tally"** function, we can see that the majority of individuals in our dataset have a pdays value of '999,' meaning they were not previously contacted. Because this 999 value is overhwelming present in our, in case skew our results and effect the efficacy of our model. **To remedy this, we will create a new pdays column ("days") that omits 999 values.** 
