...
reg_kitchensink <- glm(y_numeric ~ .,family="binomial" (link="logit"),
                  data=H_subsidyTrain %>% 
                    dplyr::select(-y, -underemploy, -bluecollar, -whitecollar, -lessthanHS, -education, -highschool, -college, -professional, -single, -divorced, -married, -nolien, -haslien, -mortgage, -nomortgage, -taxbillyes, -notaxbill, -cellular, -landline, -spring, -weeks))
