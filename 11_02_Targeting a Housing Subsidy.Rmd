...
reg_kitchensink <- glm(y_numeric ~ .,family="binomial" (link="logit"),
                  data=H_subsidyTrain %>% 
                    dplyr::select(-y, -underemploy, -bluecollar, -whitecollar, -lessthanHS, -education, -highschool, -college, -professional, -single, -divorced, -married, -nolien, -haslien, -mortgage, -nomortgage, -taxbillyes, -notaxbill, -cellular, -landline, -spring, -summer, -fallwinter, -weeks))
...
H_subsidyModel_1 <- glm(y_numeric ~ .,
                  data=H_subsidyTrain %>% 
                    ...
                    mutate(poutcome = factor(poutcome, levels = c("failure","nonexistent","success"))),
